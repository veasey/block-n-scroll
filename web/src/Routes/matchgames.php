...
$app->get('/match/{match_id}/inducements', PreGameController::class . ':showInducementsForm');
$app->post('/match/{match_id}/inducements', PreGameController::class . ':submitInducements');
