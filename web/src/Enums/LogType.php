...
enum LogType: string
{
    ...
    case PLAYER_AWARDED_MVP = 'PLAYER_AWARDED_MVP';
    case PLAYER_INCREASED_LEVEL = 'PLAYER_INCREASED_LEVEL';
    ...
    case TOUCHDOWN_LOGGED = 'TOUCHDOWN_LOGGED';
    case COMPLETION_LOGGED = 'COMPLETION_LOGGED';
    case TEAM_RENAMED = 'TEAM_RENAMED';
    case MATCH_EVENT = 'MATCH_EVENT';
    case LEAGUE_MANAGEMENT = 'LEAGUE_MANAGEMENT';
}
